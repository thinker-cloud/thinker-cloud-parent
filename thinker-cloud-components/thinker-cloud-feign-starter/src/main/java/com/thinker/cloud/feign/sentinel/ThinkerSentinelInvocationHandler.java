 ...
 */
@Slf4j
public class ThinkerSentinelInvocationHandler implements InvocationHandler {
    ...
    ThinkerSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
            ThinkerSentinelInvocationHandler other = (ThinkerSentinelInvocationHandler) obj;
