...
import com.thinker.cloud.rocketmq.trace.dispatch.AsyncDispatcher;
...
public class AsyncTraceDispatcher extends AsyncDispatcher {
    ...
    public void start(AsyncAppender appender, String workerName) {
        ...
        this.worker = ThreadUtil.newThread(new AsyncRunnable(), "MQ-AsyncDispatcher-Thread-" + workerName);
